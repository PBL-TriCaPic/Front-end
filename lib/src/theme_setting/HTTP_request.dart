...
class ApiService {
  static Future<Map<String, dynamic>> loginUser(
    ...
    final response = await http.post(
      Uri.parse('http://192.168.0.18:8081/api/login'), //エミュレータは　10.0.2.2
  ...
  static Future<Map<String, dynamic>> fetchCapsuleData(String capsuleId) async {
    final response = await http.get(
      Uri.parse('http://192.168.0.18:8081/api/get/capsules/$capsuleId'),
    );
  ...
  static Future<Map<String, dynamic>> capselSend(
    ...
    final url = Uri.parse('http://192.168.0.18:8081/api/create/capsule');
